...
const handoff = require('./simple-mind-map/bin/openclawHandoff.js')
console.log('exports', Object.keys(handoff))
console.log('ISS/AUD/TYP', handoff.ISS, handoff.AUD, handoff.TYP)

const issued = handoff.issueOpenclawHandoff(
  { id: 'user-A-test', wecomUserId: 'wxA' },
  { conversationId: 'conv-A1' }
)
console.log('issued', { keys: Object.keys(issued), requesterSenderId: issued.requesterSenderId, tokenHead: String(issued.token||issued.handoff).slice(0,40) })
