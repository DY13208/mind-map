  ...
  <div class="sopPage" :class="{ detailMode: detailMode }">
    ...
    >
      <p class="runDialogLead" v-if="runTarget">
        将「{{ runTarget.id }}：{{ runTarget.title }}」加入队列后可在后台并行执行；你可以关闭本窗口，稍后在任务中心查看进度。
      </p>
      ...
      <div class="runSectionTitle runComposeTitle"><strong>附件与补充说明</strong><span>可选</span></div>
      <div class="runComposeBox">
        <el-input
...
.sopRunDialog {
  ...
  border-radius: 12px;
  box-shadow: 0 20px 60px rgba(23, 38, 31, 0.16);
  ...
  .runModelRow {
    ...
    .el-radio-button__orig-radio:checked + .el-radio-button__inner {
      ...
      border-color: #2f76ed;
      color: #fff;
      box-shadow: inset 0 0 0 2px #dce9ff;
    }
  }
  ...
  .outputChecks {
    ...
    .el-checkbox:hover {
      border-color: #b9c9df;
      box-shadow: 0 5px 16px rgba(34, 65, 105, 0.06);
    }

    .el-checkbox.is-checked {
      border-color: #8db6f7;
      background: #f6f9ff;
      box-shadow: 0 0 0 2px rgba(47, 118, 237, 0.08);
    }
    ...
    .outputCheck--md .outputIcon {
      background: #f4edff;
      color: #8147d8;
      font-size: 15px;
    }

    .outputCheck--xlsx .outputIcon {
      background: #eaf7f2;
      color: #159568;
    }

    .outputCheck--json .outputIcon {
      background: #fff4e8;
      color: #ed7b18;
      font-size: 15px;
    }
  ...
  .runExtra {
    ...
    .el-textarea__inner:focus {
      border-color: #76a6f3;
      box-shadow: 0 0 0 3px rgba(47, 118, 237, 0.1);
    }
  }
  ...
  .runDialogFooter {
    ...
    .el-button--primary {
      ...
      background: #087854;
      border-color: #087854;
      box-shadow: 0 6px 14px rgba(8, 120, 84, 0.16);
    }
  ...
  .runExecutionScope {
    display: grid;
    grid-template-columns: minmax(170px, 0.7fr) minmax(260px, 1fr) auto;
    align-items: end;
    gap: 12px;
  }
  ...
  .runExecutionField {
    ...
    .el-radio-button__orig-radio:checked + .el-radio-button__inner {
      ...
      border-color: #087854;
      color: #087854;
      box-shadow: inset 0 0 0 1px #087854;
    }
  ...
  .runComposeBox {
    ...
    .el-textarea__inner:focus {
      border: 0;
      box-shadow: inset 0 0 0 2px rgba(8, 120, 84, 0.12);
    }
  }
...
@media (max-width: 640px) {
  .sopRunDialog {
    ...
    .runComposeBox .el-textarea__inner {
