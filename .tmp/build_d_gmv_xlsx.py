...
gaps = [
    ("销售日报表", "企业微信 smartsheet", "https://doc.weixin.qq.com/smartsheet/s3_AMwAoQZzAMECNeNTdk449SHW301Jo?tab=taDIvD",
     "登录墙：HTTP 200 但返回统一登录壳(约119KB)，无 13CHAN/UNOVE/GMV 任何数据", "在已登录企业微信的浏览器打开→导出全渠道日维度(GMV/实收)→粘贴或授权读取", "渠道运营(周中昱)+各渠道责任人"),
...
notes = [
    ...
    ("数据来源", "mind-map MCP query_nodes / search_nodes 实测：D 子树 102 节点全量拉取，渠道编码 17 个"),
]
for r in notes:
    ws4.append(list(r))
