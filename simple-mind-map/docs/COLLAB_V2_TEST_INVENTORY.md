...
| `collabV2.drain.test.js` | CYCLE_REJECTED 后 delete drain、terminal-create 依赖、SOP、FORBIDDEN、ACK refresh 异常 | Against merged created-UID dependency and current frozen FORBIDDEN stop-drain policy |
