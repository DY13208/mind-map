...
import parseAddGeneralizationUtil from './parseAddGeneralizationNodeList'
...
// 解析要添加概要的节点实例列表
export const parseAddGeneralizationNodeList =
  parseAddGeneralizationUtil.parseAddGeneralizationNodeList
