const MESSAGES = {
  ...
  HISTORY_REVISION_UNAVAILABLE: '该历史版本的资源已不可用',
  HISTORY_OPS_GAP: '该历史版本不完整，无法预览',
  HISTORY_REPLAY_FAILED: '该历史版本不完整，无法预览',
  HISTORY_REPLAY_UNSUPPORTED: '该历史版本加载失败',
  CHECKPOINT_CORRUPTED: '该历史版本加载失败',
  STALE_AFTER_VERSION_RESTORE: '脑图已恢复到新版本，本地未提交修改未自动合并',
