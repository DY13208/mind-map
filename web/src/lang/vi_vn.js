export default {
  ...
  mapRef: {
    ...
    searchNodes: 'Tìm nút trong sơ đồ đích',
    wholeMap: 'Cả sơ đồ',
    noFiles: 'Chưa có sơ đồ',
    emptySearch: 'Không có sơ đồ khớp 「{q}」',
  ...
  acl: {
    ...
    viewer: 'Chỉ xem',
    remove: 'Gỡ',
    searchUsers: 'Tìm tên hoặc tài khoản',
    addViewer: 'Thêm chỉ xem',
    addEditor: 'Thêm được sửa',
    memberAdded: 'Đã thêm thành viên',
    memberRemoved: 'Đã gỡ thành viên',
    updateFailed: 'Không cập nhật được quyền',
    demoted: 'Quyền của bạn với sơ đồ này đã thành chỉ xem',
    noAccess: 'Bạn không có quyền truy cập sơ đồ tư duy này'
  },
  cooperate: {
    ...
    newRoom: 'Phòng mới',
    roomTitlePlaceholder: 'Đặt tên cho sơ đồ tư duy',
    unnamed: 'Chưa đặt tên',
    createFailed: 'Không tạo được phòng',
    serverUrl: 'Máy chủ',
    ...
    offline: 'Chỉnh sửa ngoại tuyến',
    reconnecting: 'Đang kết nối lại',
    roomUnavailable: 'Phòng đã bị xóa hoặc không khả dụng',
    join: 'Tham gia',
    leave: 'Rời khỏi',
    ...
    roomInvalid: 'Chỉ dùng chữ cái, số, dấu chấm, gạch dưới và gạch ngang',
    ...
    peers: 'Đang online',
    you: 'Tôi',
    noOnlinePeers: 'Chưa có thành viên khác',
    chipSaved: '✓ Đã lưu',
    chipSaving: '● Đang lưu',
    chipOffline: '○ Ngoại tuyến',
    chipSyncing: '↻ Đang đồng bộ',
    chipFailed: '! Đồng bộ thất bại',
    diagTitle: 'Chi tiết lỗi đồng bộ',
    diagCopy: 'Sao chép chẩn đoán',
