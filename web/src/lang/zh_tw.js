export default {
  ...
  edit: {
    ...
    localStorageExceededTip:
      '本地草稿保存失敗。協同房間裡的圖以伺服器為準，不會因此遺失。若未進入房間，請匯出一份備份。',
    withBg: '帶背景',
    tryTipTitle: '功能試用提示',
  ...
  mapRef: {
    ...
    openEdit: '打開編輯',
    closePreview: '關閉',
    previewLoading: '正在載入子腦圖…',
    previewFailed: '子腦圖預覽失敗',
    selectedHint: '已選中：{name}',
    dblclickTip: '雙擊列表項可直接確認',
    needSelect: '請先點擊選擇一張導圖',
    needNode: '請先選中要插入子腦圖的節點'
  },
  acl: {
    share: '分享 / 權限',
    mine: '我的',
  ...
  cooperate: {
    ...
    newRoom: '新房間',
    roomTitlePlaceholder: '幫這張心智圖取個名字',
    unnamed: '未命名',
    createFailed: '建立房間失敗',
    serverUrl: '協同服務',
    ...
    roomRequired: '請輸入房間號',
    roomInvalid: '房間號只能包含字母、數字、點、底線和短橫線',
